...
To build the final jar and optimize the nova4 application for production, run:
...
[Service Discovery and Configuration with the JHipster-Registry]: https://www.jhipster.tech/documentation-archive/v9.0.0-beta.0/microservices-architecture/#jhipster-registry
